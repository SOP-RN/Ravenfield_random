...
function AntiAirHUD:Start()
    ...
    -- Remove targetIndicatorObject initialization
end
...
function AntiAirHUD:UpdateHUD()
    ...
    if self.delay >= Time.fixedDeltaTime then
        ...
        -- Remove targetIndicatorObject related functions
...
-- Remove RotateTargetIndicator and DrawLineBetweenPoints functions
...
function AntiAirHUD:HideUI()
    ...
    -- Remove targetIndicatorObject related UI hiding
